...
const uint16_t REVERSE_DISTANCE = 60;      // mm to reverse before rotation
const uint16_t SENSOR_SPACING = 50;        // mm between S2 and S1/S3
    ...
    switch (navcon_status.current_state) {
        ...
        case NAVCON_REVERSE: {
            ...
            if (current_distance >= REVERSE_DISTANCE) {
                ...
                Serial.printf("Reverse complete (distance: %d mm) - stopping before rotate\n", 
                            current_distance);
        ...
        case NAVCON_CROSSING_LINE: {
            ...
            if (sensorsAllWhite()) {
                ...
                navcon_status.correction.last_rotation_commanded = 0;
                navcon_status.black_blue_nav.first_black_blue_angle = 0;
                navcon_status.black_blue_nav.expecting_180_turn = false;
        ...
        case NAVCON_EVALUATE_CORRECTION: {
            ...
            if (navcon_status.correction.last_rotation_commanded == STEERING_CORRECTION) {
                ...
                navcon_status.current_state = NAVCON_FORWARD_SCAN;
                Serial.println("EVALUATE: Clean slate - resuming forward scan");
                return createForwardPacket();
            }
